...
export const TextEditorEmptyState = (props: AllProps) => (
  <EmptyState variant={EmptyStateVariant.small}>
    <Title headingLevel="h4" size="lg">
      No Text document
    </Title>
    <EmptyStateBody>
      A Text Document is required to enable the editor. Please either upload an existing document or create a new one or
      select a sample.
    </EmptyStateBody>
    ...
    <EmptyStateSecondaryActions>
      ...
      <Button variant="link" ouiaId="new-button" isDisabled={true}>
        Try JSON sample (not yet available)
      </Button>
    </EmptyStateSecondaryActions>
  </EmptyState>
);
