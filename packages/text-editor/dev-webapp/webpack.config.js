...
module.exports = (webpackEnv) =>
  merge(common(webpackEnv), {
    ...
    entry: {
      ...
      "text-editor-envelope": path.resolve(__dirname, "./envelope/TextEditorEnvelopeApp.ts"),
    },
    output: {
    ...
    plugins: [
      new CopyPlugin({
        patterns: [
          ...
          {
            from: path.resolve(__dirname, "./static/envelope/text-editor-envelope.html"),
            to: "./text-editor-envelope.html",
          },
        ],
      }),
